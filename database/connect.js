...
const { getDatabase, ref, child, get, query, orderByChild, equalTo} = require("firebase/database");
...
const getSearchResult = async (key, val) => {
    ...
    if(mod_key==="Brand"){
        idQuery = query(dataRef, orderByChild(mod_key), equalTo(val.toUpperCase()));
...
module.exports = { getdetail, dbRef, getSearchResult };